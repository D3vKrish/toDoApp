...
const { TaskRouter } = require('./src/routes/task.route'); // Import task management routes
...
app.use('/api/task', TaskRouter);   // Any request to '/api/task/update' will be handled by TaskRouter's put method
